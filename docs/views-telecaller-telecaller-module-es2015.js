...
/* harmony import */ var _agents_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./agents.component */ "sbTq");
/* harmony import */ var _agentdetail_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./agentdetail.component */ "RhS/");
/* harmony import */ var _customerdetail_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./customerdetail.component */ "9sCu");
/* harmony import */ var _login_auth_guard__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../login/auth.guard */ "nl+3");
...
let CustomersComponent = class CustomersComponent {
    constructor(dataservice, router, fb) {
        ...
        this.customerForm = this.fb.group({
            ...
            Landmark: ["", _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].required],
            locality: ["", _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].required],
            Post_office: ["", _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].required],
            Latitude: [""],
            Longitude: [""],
            GoogleMapURL: [""],
            GoogleMapPlusCode: [""],
...
let AgentsComponent = class AgentsComponent {
    ...
    getLists() {
        this.loading = true;
        this.dataservice.getfilteredAgents(localStorage.getItem("uid")).valueChanges.subscribe((result) => {
            console.log("getAgents", result.data.teleCallerContacts);
