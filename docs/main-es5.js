(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    "R7Hv": function R7Hv(module, __webpack_exports__, __webpack_require__) {
      ...
      var AddCustomerCommentMutation = apollo_angular__WEBPACK_IMPORTED_MODULE_4__["gql"](_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n  mutation (\n    $id: ID!\n    $remarks: String!\n    $date: DateTime!\n    $is_verified: Boolean\n  ) {\n    updateCustomer(\n      input: {\n        where: { id: $id }\n        data: {\n          TelecallerRemarks: {\n            RemarksText: $remarks\n            CallHistory: { event_date_time: $date }\n          }\n          is_verified: $is_verified\n        }\n      }\n    ) {\n      customer {\n        id\n        is_verified\n        NameOfBride\n        NameOfFather\n        NameOfMother\n        MarriageDate\n        MarriageMonth\n        tele_caller_contact {\n          Name\n          id\n        }\n        created_at\n        Address {\n          id\n          HouseName\n          Landmark\n          locality {\n            Name\n          }\n          post_office {\n            Name\n            Pincode\n            district {\n              Name\n            }\n          }\n          GeoLocation {\n            Latitude\n            Longitude\n            GoogleMapURL\n          }\n        }\n      }\n    }\n  }\n"])));
      var SetKpCallerMutation = apollo_angular__WEBPACK_IMPORTED_MODULE_4__["gql"](_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n  mutation ($id: ID!, $cust_id: [ID!]!) {\n    updateUser(input: { where: { id: $id }, data: { kp_customer: $cust_id } }) {\n      user {\n        id\n        kp_customer {\n          id\n          NameOfBride\n          NameOfFather\n        }\n      }\n    }\n  }\n"])));
      var SetTeleCallerMutation = apollo_angular__WEBPACK_IMPORTED_MODULE_4__["gql"](_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n  mutation ($id: ID!, $cust_id: [ID!]!) {\n    updateUser(\n      input: { where: { id: $id }, data: { tele_caller_contacts: $cust_id } }\n    ) {\n      user {\n        id\n        tele_caller_contacts {\n          id\n          Name\n          Contact_Number_1\n          Email\n        }\n      }\n    }\n  }\n"])));
      var SetFieldAgentMutation = apollo_angular__WEBPACK_IMPORTED_MODULE_4__["gql"](_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["\n  mutation ($id: ID!, $cust_id: [ID!]!) {\n    updateUser(input: { where: { id: $id }, data: { customers: $cust_id } }) {\n      user {\n        id\n        customers {\n          NameOfBride\n          id\n          NameOfFather\n          MarriageDate\n        }\n      }\n    }\n  }\n"])));
      var UsersQuery = apollo_angular__WEBPACK_IMPORTED_MODULE_4__["gql"](_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["\n  query ($type: String!) {\n    users(where: { UserType: $type }) {\n      id\n      username\n      email\n      role {\n        id\n        name\n        type\n      }\n      UserType\n    }\n  }\n"])));
      var AddCustomerEnquiry = apollo_angular__WEBPACK_IMPORTED_MODULE_4__["gql"](_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["\n  mutation (\n    $Name: String!\n    $PhoneNumber: String!\n    $isWeddingPurchase: Boolean!\n    $MarriageDate: Date!\n    $QtyOfGold: Int!\n    $OptNoCostEMI: Boolean!\n    $HouseName: String!\n    $Landmark: String!\n    $PostOfficeNumber: Long!\n  ) {\n    createCustomerEnquiry(\n      input: {\n        data: {\n          Name: $Name\n          PhoneNumber: $PhoneNumber\n          isWeddingPurchase: $isWeddingPurchase\n          MarriageDate: $MarriageDate\n          QtyOfGold: $QtyOfGold\n          OptNoCostEMI: $OptNoCostEMI\n          HouseName: $HouseName\n          Landmark: $Landmark\n          PostOfficeNumber: $PostOfficeNumber\n        }\n      }\n    ) {\n      customerEnquiry {\n        id\n        Name\n        PhoneNumber\n        isWeddingPurchase\n        MarriageDate\n        QtyOfGold\n        OptNoCostEMI\n        HouseName\n        Landmark\n        PostOfficeNumber\n      }\n    }\n  }\n"])));
